# AI Agent Reference for ha-moneymanager
...
| Area | Path |
|---|---|
| Integration Entry | `custom_components/moneymanager/__init__.py` |
| Coordinator | `custom_components/moneymanager/coordinator.py` |
| API Client | `custom_components/moneymanager/api.py` |
| Sensors | `custom_components/moneymanager/sensor.py` |
| Binary Sensor | `custom_components/moneymanager/binary_sensor.py` |
| Button | `custom_components/moneymanager/button.py` |
| Options Flow | `custom_components/moneymanager/config_flow.py` |
| Tests | `tests/` |
...
| mypy linter | `mypy custom_components/moneymanager` | Root |
